  ...
  return (
    ...
    >
      ...
      <div className="bg-slate-800/50 backdrop-blur-xl rounded-xl p-6 border border-white/10">
        <p className="text-gray-400">Dobrodošli u vaš profesorski panel. Ovdje možete pratiti svoje učenike, organizovati časove i upravljati svojim rasporedom korepeticija.</p>
      </div>
    </motion.div>
  );
};
